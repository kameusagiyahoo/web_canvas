...
# rerun with window-level pointer tracking so desktop mouse and mobile touch share one path
...
# Mark graph node target and add a drag handle. Pointer movement/up is tracked on window.
replace_once(
    "components/NavigationGraph.tsx",
